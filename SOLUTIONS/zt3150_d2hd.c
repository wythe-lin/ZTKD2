...
#include "d2layer2.h"
	...
	#define CONFIG_SENCLK	12
	#define CLK_SENSOR	(CONFIG_SENCLK*2)
...
#endif
	// SOU TG parameters
	{0x41B, 0x12}, {0x41C, 0x0F},	// 3858
	{0x41D, 0x04}, {0x41E, 0x00},
	{0x41F, 0x08}, {0x420, 0x00},
	{0x421, 0x08}, {0x422, 0x00},
	{0x423, 0x07}, {0x424, 0x0F},	// 3847

	{0x425, 0x3E}, {0x426, 0x04},	// 1086
	{0x427, 0x01}, {0x428, 0x00},
	{0x42B, 0x02}, {0x42C, 0x00},
	{0x42F, 0x02}, {0x430, 0x00},
	{0x431, 0x39}, {0x432, 0x04},	// 1081
	// SOU Control
	{0x411, 0x05},
};
...
unsigned char fnD2RunQuadSensors(unsigned ucMode)
{
	...
	switch (ucMode) {
	case D2_SENSOR_QUAD_PANORAMA:		// h side by side
	case D2_SENSOR_STITCH_PANORAMA:		// accurate stitch
	case D2_SENSOR_QUAD_ACBD:		// h side by side
	case D2_SENSOR_QUAD_ABCD:		// v side by side
	case D2_SENSOR_STITCH_ABCD:		// v side by side
		fnD2WriteTable(D2TableBuffers, sizeof(D2TableBuffers) / sizeof(tD2Register));
