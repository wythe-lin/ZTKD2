//
// Zealtek D2 project
// ZT3120 with VGA image sensor solutions
//
...
#include "d2.h"
	...
	// Buffer size for VGA video sensors is 720x576 = 829,440.
...
tD2Register code D2TableSIU_PAL[] =
{
	...
	{0x233, 0x00},
	#endif // DECODER_WIDTH_720
	{0x234, 0x00},//Cropped PAL height to meet VGA height.
	{0x235, 0x00},//Cropped PAL height to meet VGA height.
	#ifdef DECODER_WIDTH_720
	{0x236, 0xA0},
	{0x237, 0x05},
	#else  // DECODER_WIDTH_720
	...
	#endif // DECODER_WIDTH_720
	#ifdef DECODER_DE_INTERLACE
	{0x238, 0xF0},//Cropped PAL height to meet VGA height.
	{0x239, 0x00},//Cropped PAL height to meet VGA height.
	#else  // DECODER_DE_INTERLACE
	{0x238, 0xE0},//Cropped PAL height to meet VGA height.
	{0x239, 0x01},//Cropped PAL height to meet VGA height.
	#endif // DECODER_DE_INTERLACE
	{0x23B, 0x00},
	{0x23C, 0x00},
	{0x23D, 0x00},
...
tD2Register code D2TableSOU_CVBS[] =
...
{	// 1360x480, 26.5fps at 40MHz, LDC_PATCH on
	// 1280x480, 29.2fps at 40MHz, LDC_PATCH on
	// 1360x480, 27fps at 40MHz, LDC_PATCH off
	// 1280x480, 30fps at 40MHz, LDC_PATCH off
	// 1360x480, 30fps at 48MHz
...
tD2Register code D2TableSOU_HalfVGA[] =
{	// 680x480, 30fps at 24MHz
	// 640x480, 30fps at 24MHz
	// SOU Configuration
	{0x400, 0x08},
	{0x410, 0x01},
	...
	unsigned char ucResolution)
{
	...
	case D2_RESOLUTION_VGA_60Hz:
		fnD2WriteTable(D2TableSOU_CVBS, sizeof(D2TableSOU_CVBS) / sizeof(tD2Register));
	...
	unsigned char ucResolution)
{
	...
	{
	case D2_RESOLUTION_VGA_60Hz:
		fnD2WriteTable(D2TableSOU_HalfVGA, sizeof(D2TableSOU_HalfVGA) / sizeof(tD2Register));
