...
#include "d2layer2.h"
	...
	#define SOU_VGACLK    24
		...
		#if IMAGE_STITCHING_SIZE == STITCHING_SIZE_1920x496
			#define ACST_OUT_WIDTH		1920
		#else
			#define ACST_OUT_WIDTH		2560
		#endif // IMAGE_STITCHING_SIZE
		#define ACST_OUT_HEIGHT			496
...
tD2Register code D2TableBuffers[] = {
	...
	{0x21E, 0x00}, {0x21F, 0xC0}, {0x220, 0x13},
	{0x222, 0x00}, {0x223, 0x80}, {0x224, 0x26},
	{0x226, 0x00}, {0x227, 0x40}, {0x228, 0x39},
	{0x22A, 0x00}, {0x22B, 0x00}, {0x22C, 0x4C},
	{0x22E, 0x00}, {0x22F, 0xC0}, {0x230, 0x5E},
	// IPU Memory Buffers
	{0x304, 0x00}, {0x305, 0x00}, {0x306, 0x01},
	{0x308, 0x00}, {0x309, 0xC0}, {0x30A, 0x13},
	{0x30C, 0x00}, {0x30D, 0x80}, {0x30E, 0x26},
	{0x310, 0x00}, {0x311, 0x40}, {0x312, 0x39},
	{0x314, 0x00}, {0x315, 0x00}, {0x316, 0x4C},
	{0x318, 0x00}, {0x319, 0xC0}, {0x31A, 0x5E},
};
...
unsigned char fnD2RunQuadSensors(unsigned ucMode)
{
	...
	case D2_SENSOR_QUAD_PANORAMA:
		fnD2WriteTable(D2TableBuffers, sizeof(D2TableBuffers) / sizeof(tD2Register));
		fnD2WriteTable(D2TableSOU_QuadVGA, sizeof(D2TableSOU_QuadVGA) / sizeof(tD2Register));
		fnD2WriteTable(D2TableIPU_DualVGA, sizeof(D2TableIPU_DualVGA) / sizeof(tD2Register));
		fnD2WriteTable(D2TableHorizontalSideBySide, sizeof(D2TableHorizontalSideBySide) / sizeof(tD2Register));
		fnD2WriteTable(D2TableSIU_DualVGA, sizeof(D2TableSIU_DualVGA) / sizeof(tD2Register));
		ucSIU_CONTROL = 0x0F;
	...
	case D2_SENSOR_STITCH_PANORAMA:
		...
		fnD2WriteTable(D2TableSOU_QuadVGA, sizeof(D2TableSOU_QuadVGA) / sizeof(tD2Register));
		fnD2WriteTable(D2TableIPU_DualVGA, sizeof(D2TableIPU_DualVGA) / sizeof(tD2Register));
		fnD2WriteTable(D2TableAccurateStitch, sizeof(D2TableAccurateStitch) / sizeof(tD2Register));
		fnD2WriteTable(D2TableSIU_DualVGA, sizeof(D2TableSIU_DualVGA) / sizeof(tD2Register));
		ucSIU_CONTROL = 0x0F;
		return SUCCESS;
	...
	case D2_SENSOR_STITCH_ABCD:
		fnD2WriteTable(D2TableBuffers, sizeof(D2TableBuffers) / sizeof(tD2Register));
		fnD2WriteTable(D2TableSOU_CubeVGA, sizeof(D2TableSOU_CubeVGA) / sizeof(tD2Register));
		fnD2WriteTable(D2TableIPU_DualVGA, sizeof(D2TableIPU_DualVGA) / sizeof(tD2Register));
		fnD2WriteTable(D2TableVerticalSideBySide, sizeof(D2TableVerticalSideBySide) / sizeof(tD2Register));
		fnD2WriteTable(D2TableSIU_DualVGA, sizeof(D2TableSIU_DualVGA) / sizeof(tD2Register));
		ucSIU_CONTROL = 0x0F;
