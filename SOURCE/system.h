...
//
// Send debugging information from UART TX
//
//#define DBG
	...
	#define SUPPORT_D2_OPERATION
	#define SUPPORT_HORIZONTAL_SIDE_BY_SIDE
	#define SUPPORT_VERTICAL_SIDE_BY_SIDE
	#define SUPPORT_FUZZY_STITCHING
	#include "zt3150.h"
#endif // ZT3150
	...
	// SDRAM_8MB_4x16 now works for all ZT3120 solutions, and ZT3150 VGA solutions.
	// SDRAM_16MB_8x16 works for ZT3150 HD solutions.
...
//
	...
	#define CMD_D2_PAN_ADJUST          0x0A
#endif // SUPPORT_D2_PAN

#ifdef SPI_INTERFACE
	#define CMD_D2_GET_FLASH_ADDRESS   0x10
	#define CMD_D2_SET_FLASH_ADDRESS   0x11
	#define CMD_D2_GET_BUFFER_ADDRESS  0x12
	#define CMD_D2_SET_BUFFER_ADDRESS  0x13
	#define CMD_D2_READ_FLASH_MEMORY   0x14
	#define CMD_D2_WRITE_FLASH_MEMORY  0x15
	#define CMD_D2_ERASE_FLASH_MEMORY  0x16
#endif // SPI_INTERFACE
	...
	//
		...
		#define D2_OPERATION_ANAGLYPH_STITCHING      6
	#endif // SUPPORT_ANAGLYPH_STITCHING
	#ifdef SUPPORT_FUZZY_STITCHING
		#define D2_OPERATION_SCALED_STITCHING        6
		#define D2_OPERATION_FUZZY_STITCHING         7
		#define D2_OPERATION_ACCURATE_STITCHING      8
	#endif // SUPPORT_FUZZY_STITCHING
	#ifdef SUPPORT_WDR_STITCHING
		#define D2_OPERATION_WDR_STITCHING           9
		#define D2_OPERATION_LDC_WDR_STITCHING      10
...
#ifdef SUPPORT_D2_PAN
	//
	// D2 Panorama Adjustment Parameters
	//
	#define D2_PAN_NONE                0x00
	#define D2_PAN_LEFT                0x01
	#define D2_PAN_RIGHT               0x02
	#define D2_PAN_UP                  0x10
	#define D2_PAN_DOWN                0x20

	extern void fnPanInitial();
	extern unsigned char fnPanSetValue(
